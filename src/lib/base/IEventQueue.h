...
public:
  ...
  */
  ...
  The handler can remove itself while handling the current event. Handler changes made while
  dispatching an event do not affect the handler already selected for that event.
  */
