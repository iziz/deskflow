...
const char *const kMsgDClipboardChannelHello = "DCHN%s";
...
const char *const kMsgCClipboardAck = "CACK%4i";
const char *const kMsgCClipboardCancel = "CCAN%4i%1i";
const char *const kMsgCClipboardProgress = "CPRG%4i%4i";
const char *const kMsgCClipboardChannelOffer = "CCHO%s";
const char *const kMsgCClipboardChannelReady = "CCHY";
...
const char *const kMsgDClipboardTransfer = "DCL2%1i%4i%4i%1i%s";
...
const char *const kMsgQClipboardChannel = "QCHN";
