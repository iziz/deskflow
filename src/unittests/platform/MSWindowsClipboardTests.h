...
private Q_SLOTS:
  ...
  void bitmapConverter_normalizesBitmapV5DibToIClipboard();
  void bitmapConverter_trimsTrailingBytesToIClipboard();
  void bitmapConverter_supportsDibV5ClipboardFormat();
